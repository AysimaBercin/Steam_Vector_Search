...
*   **Büyük Veri İşleme:** 137.000+ satırlık veri seti, bellek yönetimi (batch processing) kullanılarak veritabanına aktarılmıştır.
...
*   **Profesyonel Arayüz:** Streamlit kullanılarak sade ve veri odaklı bir kullanıcı deneyimi tasarlanmıştır.
...
*   app.py: Streamlit tabanlı kullanıcı arayüzü ve arama motoru ana kodları.
